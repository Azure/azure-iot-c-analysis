...
typedef struct REPORT_INFO_TAG* HEALTH_REPORTER_HANDLE;
    ...
    MOCKABLE_FUNCTION(, int, health_reporter_register_health_item, HEALTH_REPORTER_HANDLE, handle, HEALTH_ITEM_HANDLE, item_handle, HEALTH_REPORTER_CONSTRUCT_JSON, construct_json);
